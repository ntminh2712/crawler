...
public class SourceParamester {
    ...
    public SourceParamester(String url, String title_selector, String link_selector, String content_selector, String remove_selector, String author_selector, String description_selector, String thumnail_selector, long category_id) {
        this.url = url;
